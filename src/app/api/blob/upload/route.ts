...
//
// Autenticação com o Blob: o SDK v2 resolve automaticamente —
//   1) usa BLOB_READ_WRITE_TOKEN se existir, OU
//   2) usa OIDC (VERCEL_OIDC_TOKEN + BLOB_STORE_ID), o modelo novo criado ao
//      conectar o Blob store ao projeto.
// Não exigimos o token fixo aqui, para o OIDC funcionar.
